...
For example:
```
cp ERR599142_assembly_vs_North_Pacific_ERR599142_sorted.bam .
cp ERR599142_assembly_vs_North_Pacific_ERR599142_sorted.bam.bai .
cp ERR599142_assembly_vs_Southern_Ocean_ERR599008_sorted.bam .
cp ERR599142_assembly_vs_Southern_Ocean_ERR599008_sorted.bam.bai .
cp ERR599142_assembly_vs_Southern_Ocean_ERR599090_sorted.bam .
cp ERR599142_assembly_vs_Southern_Ocean_ERR599090_sorted.bam.bai .
```
