 ...
 **gather.town.**
 ...
 If you are working on lab synchronously, hop on gather.town (see Moodle for link) while you're working. There's a quiet corner where you can hang out (you can turn videos and mics off). This will help facilitate support that's easier answered over video/screenshare rather than over Slack. I'll be logged on and you can find me in "Rika's corner." You can also compare notes with other people. *There will be a couple steps below that require conferring with other people on gather.town.* If you're working synchronously but nobody else is at the same stage as you, come find Rika. If you're on a different time zone or can't work synchronously for whatever reason, just move on to the next step, and you can post questions on Slack if they come up.
...
**For those of you able to work synchronously:** If you aren't on gather.town already, log on. Head to one of the tables with a shared Google doc (Tables 1-5). Discuss the questions you see there. For those of you doing this on Tuesday, we likely won't have covered the details of kmers and N50 yet, so discuss the patterns you see and we'll fill in the concepts in class. For those of you doing this on Thursday, you should be able to explicitly discuss kmer length and N50 with regards to your assemblies. Feel free to find Rika to ask questions if something isn't working or doesn't make sense.
...
**If you are able to work synchronously:** Hop back on gather.town and head to one of the tables with a shared Google doc (Tables 1-5) and discuss the questions on the shared Google doc. If it's helpful, it's possible to share your screen in gather.town.
