...
**For those of you able to work synchronously:** If you aren't on gather.town already, log on and head to one of the tables with a shared Google doc (Tables 1-5). Discuss the questions you see there. For those of you doing this on Tuesday, we likely won't have covered the details of kmers and N50 yet, so discuss the patterns you see and we'll fill in the concepts in class. For those of you doing this on Thursday, you should be able to explicitly discuss kmer length and N50 with regards to your assemblies. Feel free to find Rika to ask questions if something isn't working or doesn't make sense.
